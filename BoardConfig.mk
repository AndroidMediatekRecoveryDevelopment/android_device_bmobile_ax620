...
-include vendor/bmobile/ax620/BoardConfigVendor.mk
...
TARGET_BOOTLOADER_BOARD_NAME := ax620
...
BOARD_CUSTOM_BOOTIMG_MK := device/bmobile/ax620/bootimg.mk
BOARD_MKBOOTIMG_ARGS := --mtk 1

TARGET_PREBUILT_KERNEL := device/bmobile/ax620/prebuilt/kernel
TARGET_RECOVERY_INITRC := device/bmobile/ax620/recovery/init.mt6572.rc
TARGET_RECOVERY_FSTAB := device/bmobile/ax620/recovery/recovery.fstab
...
TARGET_COMMON_NAME := bmobile ax620
